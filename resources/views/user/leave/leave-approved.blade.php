            ...
            <div class="table-responsive">
                <table class="table table-centered table-nowrap mb-0 rounded" id="table_id">
                    ...
                    <!-- Start of Item -->
                        ...
                        @if($value->main_department_id == Auth::user()->main_department_id && $value->sub_department_id == Auth::user()->sub_department_id && $value->user_designation != Auth::user()->user_designation)
                        ...
                        <td class="border-0 font-weight-bold"><a href="{{route('user_leave_edit',['id'=>$value->id])}}" class="text-secondary mr-3"><i class="fas fa-edit"></i>Edit</a></td>
                        @endif
                        </tr>
                        @endforeach
                    <!-- End of Item -->
