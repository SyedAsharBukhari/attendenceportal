...
<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-md-none">
    ...
    <div class="sidebar-inner px-4 pt-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{route('user.attendance')}}" class="nav-link">
                <span class="sidebar-icon"><span class="fas fa-users"></span></span>
                <span>My Attendance</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{route('user_leave')}}" class="nav-link">
                <span class="sidebar-icon"><span class="fas fa-users"></span></span>
        ...
        <li class="nav-item">
            <a href="{{ route('user_leave_approved') }}" class="nav-link">
                <span class="sidebar-icon"><span class="fas fa-users"></span></span>
...
<div class="row align-items-center">
  ...
  <div class="col pl-0 ml--2">
    <div class="d-flex justify-content-between align-items-center">
        <div>
          <h4 class="h6 mb-0 text-small">{{Auth::user()->username}}</h4>
        </div>
        <div class="text-right">
...
<span class="mb-0 font-small font-weight-bold">{{Auth::user()->username}}</span>
</div>
</div>
</a>
<div class="dropdown-menu dashboard-dropdown dropdown-menu-right mt-2">
<a class="dropdown-item font-weight-bold" href="{{route('user_profile')}}"><span class="far fa-user-circle"></span>My Profile</a>
