    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Designation Add</h1>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-lg-12 col-sm-12">
                                ...
                                @endif
                                <form action="{{route('admin_designation_add_edit')}}" method="POST" enctype="multipart/form-data">@csrf
                                    <div class="mb-4">
                                        <label for="title">Designation Name</label>
                                        <input type="text" class="form-control" required name="designation_name">
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" id="sub_department_id" name="sub_department_id">
                                            ...
                                            @if($sub_depart)
                                            @foreach($sub_depart as $sub_depart)
                                            <option value="{{$sub_depart->id}}">{{$sub_depart->sub_department_name}}</option>
                                            @endforeach
                                            @endif
